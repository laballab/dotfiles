...
ZSH_THEME_GIT_PROMPT_STAGED="%{$fg_bold[green]%}r%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_UNSTAGED="%{$fg_bold[yellow]%}m%{$reset_color%}"
...
_PATH="%{$fg_bold[white]%}%4~%{$reset_color%}"
...
setopt prompt_subst
PROMPT='$(nice_exit_code)> $_LIBERTY '
RPROMPT='$(kube_ps1)$(bureau_git_prompt)'
